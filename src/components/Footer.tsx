          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-slate-600">
                ...
                <a href="https://wa.me/992940076006" target="_blank" rel="noopener noreferrer" className="hover:text-[#25D366] transition-colors font-medium">WhatsApp Us</a>
              </li>
              <li className="flex items-center gap-3 text-slate-600">
                ...
                <a href="https://t.me/salamconsultingsupport" target="_blank" rel="noopener noreferrer" className="hover:text-[#0088cc] transition-colors font-medium">Telegram Support</a>
              </li>
            </ul>
          </div>
        </div>

    ...
    <footer className="bg-slate-50 pt-16 md:pt-24 pb-8 md:pb-12 border-t border-slate-200 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-12 mb-12 md:mb-16">
          ...
          <div>
            <h3 className="text-slate-900 font-bold text-lg mb-6">{tFooter('quickLinks')}</h3>
            <ul className="space-y-4">
              <li><Link href="/" className="text-slate-600 text-[15px] hover:text-slate-900 transition-colors">{tNav('home')}</Link></li>
              <li><Link href="/study-abroad" className="text-slate-600 text-[15px] hover:text-slate-900 transition-colors">{tNav('destinations')}</Link></li>
              <li><Link href="/contact" className="text-slate-600 text-[15px] hover:text-slate-900 transition-colors">{tNav('contact')}</Link></li>
            </ul>
          </div>

          <div>
            <h3 className="text-slate-900 font-bold text-lg mb-6">{tNav('contact')}</h3>
            <ul className="space-y-4">
              ...
              <li className="text-slate-600">
                <a href="https://wa.me/992940076006" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-[#25D366] transition-colors group">
                  ...
                  <span className="font-medium">{tFooter('whatsappUs')}</span>
                </a>
              </li>
              <li className="text-slate-600">
                <a href="https://t.me/salamconsultingedu" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-[#0088cc] transition-colors group">
                  ...
                  <span className="font-medium">{tFooter('telegramSupport')}</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-slate-200 flex flex-col-reverse md:flex-row items-center justify-between gap-6">
          <p className="text-slate-500 text-[15px]">
            © {new Date().getFullYear()} Salam Consulting. {tFooter('allRightsReserved')}
          </p>
          <div className="flex items-center gap-4 text-slate-500">
            <a href="https://www.instagram.com/salamconsultingedu?igsh=MWl0ZGk4Zm94NmhpNw==" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center hover:bg-slate-50 hover:text-blue-600 hover:border-blue-200 transition-all shadow-sm hover:shadow">
            ...
            <a href="https://t.me/salamconsultingedu" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center hover:bg-slate-50 hover:text-blue-600 hover:border-blue-200 transition-all shadow-sm hover:shadow">
